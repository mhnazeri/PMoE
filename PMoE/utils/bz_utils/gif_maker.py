"""source: https://github.com/dotchen/LearningByCheating/blob/release-0.9.6/bird_view/utils/bz_utils/gif_maker.py"""
...
class Dummy(object):
    ...
    def save(cls, key, save_dir=None, save_path=None, duration=0.1):
        ...
        imageio.mimsave(
            str(save_dir.joinpath(save_path)), cls.images[key], "GIF", duration=duration
        )
