"""source: https://github.com/dotchen/LearningByCheating/blob/release-0.9.6/bird_view/utils/bz_utils/saver.py"""
import copy
import json
...
class Experiment(object):
    ...
    def end_epoch(self, net=None):
        ...
        if net is not None:
            if self.epoch % 10 == 0:
                torch.save(
                    net.state_dict(), str(self.log_dir / ("model_%03d.t7" % self.epoch))
                )
